...
const steps = [
  { year: '2016', title: 'Le Gang prend vie', text: 'Tout a commencé ave Drague Azonto. Adigoue Gboun Gboun est sorti et le Bénin entier a retenu le nom. S\'en est suivi....', images: ['/img/history/2016_1_1.jpg', '/img/history/2016_3.jpg', '/img/history/2016_4.jpg'], cssClass: 'note-1', accent: 'accent-red' },
  ...
  { year: '2019', title: 'Le virage', text: 'Madame est arrivé et tout a changé. Nous vous avons prouvé ce jour-là qu\'un artiste qui n\'évolue pas disparaît. Vous avez suivi. Sans hésiter.', images: ['/img/history/2019_1.jpg'], cssClass: 'note-4', accent: 'accent-red' },
